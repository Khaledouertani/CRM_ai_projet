        ...
        <div className="relative group">
          ...
          <div className="relative bg-card border border-border rounded-[40px] shadow-2xl p-8 lg:p-12 overflow-hidden">
            <div className="relative z-10 mb-10">
              <h2 className="text-3xl font-black italic tracking-tighter text-foreground uppercase mb-2">Nouveau <span className="text-gradient-primary">Accès</span></h2>
              <p className="text-muted-foreground text-xs font-bold uppercase tracking-widest">Définissez votre nouveau mot de passe</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              <div className="space-y-2">
                ...
                <div className="relative group/input">
                  ...
                  <Input
                    ...
                    className="pl-12 pr-14 py-7 rounded-2xl bg-background/50 border border-border text-foreground placeholder:text-muted-foreground/60 focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:border-primary/50 transition-all text-sm font-medium"
                    placeholder="••••••••"
                    required
                  />
                  <button
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-muted-foreground text-[10px] font-black uppercase tracking-widest ml-1">
