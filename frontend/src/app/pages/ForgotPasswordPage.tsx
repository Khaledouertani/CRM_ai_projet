        ...
        <div className="relative group">
          ...
          <div className="relative bg-card border border-border rounded-[40px] shadow-2xl p-8 lg:p-12 overflow-hidden">
            <button 
              ...
              className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors text-[10px] font-black uppercase tracking-widest mb-8"
            >
              <ArrowLeft className="w-4 h-4" /> Retour à la connexion
            </button>

            <div className="relative z-10 mb-10">
              <h2 className="text-3xl font-black italic tracking-tighter text-foreground uppercase mb-2">Récupération</h2>
              <p className="text-muted-foreground text-xs font-bold uppercase tracking-widest">Entrez votre email pour recevoir un lien</p>
            </div>

            {!submitted ? (
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="space-y-2">
                  <Label htmlFor="email" className="text-muted-foreground text-[10px] font-black uppercase tracking-widest ml-1">
                    Adresse Email
                  </Label>
                  <div className="relative group/input">
                    ...
                    <Input
                      ...
                      className="pl-12 py-7 rounded-2xl bg-background/50 border border-border text-foreground placeholder:text-muted-foreground/60 focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:border-primary/50 transition-all text-sm font-medium"
              ...
              <div className="text-center py-8 space-y-4">
                ...
                <h3 className="text-xl font-bold text-foreground">Email envoyé !</h3>
                ...
                <Button 
                  onClick={() => navigate('/login')}
                  variant="outline" 
                  className="mt-6 border-border text-muted-foreground hover:bg-primary/10"
                >
                  Retourner au Login
                </Button>
              </div>
